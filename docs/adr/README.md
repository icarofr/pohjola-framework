...
| [002](ADR-002-auth-shape.md) | Auth shape | Accepted — session lifecycle implemented; CSRF is `sameOriginOk` on mutating POST |
...
| [005](ADR-005-csrf.md) | CSRF | Accepted — `Sec-Fetch-Site` primary, `Origin` secondary, implemented as `App.Server.sameOriginOk` |
