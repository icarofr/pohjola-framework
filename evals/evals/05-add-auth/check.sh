...
# do not wire requireAuth into Main; CSRF is origin-gated)
set -euo pipefail
...
check "CSRF origin-gated in GUARANTEES" "grep -q 'Sessions (App.Auth) — implemented; CSRF is origin-gated' docs/GUARANTEES.md"
