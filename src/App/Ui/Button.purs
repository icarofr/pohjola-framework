...
renderVariant = case _ of
  Primary -> "bg-emerald-700 hover:bg-emerald-800 text-white shadow-xs border border-emerald-800/30 focus-visible:outline-emerald-700 dark:bg-emerald-600 dark:hover:bg-emerald-500 active:scale-[0.98]"
  Secondary -> "bg-zinc-900 hover:bg-zinc-800 text-white shadow-xs border border-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-white active:scale-[0.98]"
  Outline -> "bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800 shadow-2xs active:scale-[0.98]"
  Ghost -> "text-zinc-700 dark:text-zinc-300 hover:text-zinc-950 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-zinc-800/60"
  Inverted -> "bg-white text-zinc-950 hover:bg-zinc-100 font-semibold shadow-xs border border-zinc-200/50 active:scale-[0.98]"
