...
renderPostCard lang post =
  ...
  in
    el "article"
      [ class_ "group relative flex flex-col justify-between rounded-2xl bg-white p-6 sm:p-7 shadow-xs ring-1 ring-gray-200 hover:shadow-lg hover:ring-indigo-500/40 hover:-translate-y-1 dark:bg-gray-900/60 dark:ring-white/10 dark:hover:ring-indigo-400/40 transition-all duration-200 cursor-pointer"
      ]
      [ el "div" []
          [ -- Header metadata row: category pill + read time indicator
            el "div" [ class_ "flex items-center justify-between text-xs" ]
              [ el "span"
                  [ class_ "inline-flex items-center rounded-md bg-indigo-50 px-2.5 py-1 font-semibold text-indigo-700 ring-1 ring-inset ring-indigo-700/10 dark:bg-indigo-500/10 dark:text-indigo-400 dark:ring-indigo-400/30" ]
                  [ text categoryTag ]
          ...
          , el "div" [ class_ "mt-4" ]
              [ el "h2"
                  [ class_ "font-display text-lg font-bold tracking-tight text-gray-900 group-hover:text-indigo-600 dark:text-white dark:group-hover:text-indigo-400 transition-colors leading-snug" ]
      ...
      , el "div" [ class_ "mt-6 flex items-center justify-between pt-4 border-t border-gray-100 dark:border-white/5" ]
          [ el "div" [ class_ "flex items-center gap-x-2.5" ]
              [ el "div" [ class_ "size-7 rounded-full bg-gradient-to-tr from-indigo-600 to-indigo-400 flex items-center justify-center text-white text-xs font-bold shadow-xs" ]
                  [ text "P" ]
          ...
          , el "div" [ class_ "flex items-center gap-x-1 text-xs font-semibold text-indigo-600 dark:text-indigo-400 group-hover:translate-x-0.5 transition-transform" ]
              [ text d.readMore
