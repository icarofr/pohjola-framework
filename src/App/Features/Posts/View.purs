    ...
    container "max-w-4xl" "py-16 sm:py-24"
      ...
      , el "article" [ class_ "rounded-3xl bg-white p-8 sm:p-14 shadow-xs ring-1 ring-gray-200 dark:bg-gray-900/60 dark:ring-white/10" ]
          [ el "div" [ class_ "flex items-center gap-x-3 text-xs mb-4" ]
              [ el "span" [ class_ "inline-flex items-center rounded-md bg-indigo-50 px-2.5 py-1 font-semibold text-indigo-700 ring-1 ring-inset ring-indigo-700/10 dark:bg-indigo-500/10 dark:text-indigo-400 dark:ring-indigo-400/30" ]
                  [ text categoryTag ]
          ...
          , el "div" [ class_ "mt-6 flex items-center gap-x-3.5 pb-8 border-b border-gray-100 dark:border-white/5" ]
              [ el "div" [ class_ "size-10 rounded-full bg-gradient-to-tr from-indigo-600 to-indigo-400 flex items-center justify-center text-white text-sm font-bold shadow-xs" ]
                  [ text "P" ]
          ...
          , el "div" [ class_ "mt-8" ]
              [ el "p" [ class_ "text-lg/8 text-gray-700 dark:text-gray-300 leading-relaxed font-normal whitespace-pre-line" ]
                  [ text (postBody post) ]
              , el "div" [ class_ "my-8 rounded-2xl bg-indigo-50/60 p-6 border border-indigo-100 dark:bg-indigo-500/10 dark:border-indigo-500/20" ]
                  [ el "p" [ class_ "text-xs font-bold uppercase tracking-wider text-indigo-700 dark:text-indigo-400" ]
                      [ text "Framework Guarantee" ]
                  , el "p" [ class_ "mt-2 text-sm/6 text-indigo-950 dark:text-indigo-200 font-normal" ]
