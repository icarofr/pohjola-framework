-- | Posts feature views — list and detail views using pure DaisyUI components
    ...
    Ui.pageLayout
      ...
      , content:
          if null posts then
            ...
            Ui.grid3 (map (renderPostCard lang) posts)
      }
  ...
  in
    container "max-w-3xl" "py-16 text-center"
      [ Ui.emptyState
          ...
          , action: Just (spaLink lang PostList [ class_ "btn btn-primary btn-sm" ] [ text d.backToList ])
          }
      ]
