...
spec = do
  describe "App.DatastarShell" do
    ...
    it "marks the current route in mobile drawer with the brand color" do
      ...
      html
        `shouldContain`
          ( "href=\"/en\" data-on:click=\"evt.preventDefault(); $_drawerOpen = false; @get(&#x27;/en&#x27;, {payload: {}})\" aria-current=\"page\" class=\"btn btn-ghost justify-start text-primary font-semibold\""
          )
