  ...
  describe "Route" do
    describe "parseRoute" do
      ...
      it "parses /pt/contact" do
        parseRoute [ "pt", "contact" ] `shouldEqual` Just { lang: Pt, route: Contact }
      ...
      it "parses /pt/posts as PostList" do
        parseRoute [ "pt", "posts" ] `shouldEqual` Just { lang: Pt, route: PostList }
      ...
      it "parses /pt/posts/42 as PostDetail 42" do
        parseRoute [ "pt", "posts", "42" ] `shouldEqual` Just { lang: Pt, route: PostDetail 42 }
    ...
    describe "routeUrl" do
      ...
      it "generates /pt/about" do
        routeUrl Pt About `shouldEqual` "/pt/about"
      ...
      it "generates /pt/contact" do
        routeUrl Pt Contact `shouldEqual` "/pt/contact"
      ...
      it "generates /pt/posts for PostList" do
        routeUrl Pt PostList `shouldEqual` "/pt/posts"
      ...
      it "generates /pt/posts/42 for PostDetail 42" do
        routeUrl Pt (PostDetail 42) `shouldEqual` "/pt/posts/42"
